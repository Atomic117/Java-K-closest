...
THOMAS TRAN
Most of the class remains unedited except for the implementation of Comparable
------------------------------------------------------------------------------------*/
class LabelledPoint implements Comparable<LabelledPoint>{
    ...
    //Overriding the compare method from Comparable interface
    //Compares the keys between two objects (which will be distance from query)
    @Override
